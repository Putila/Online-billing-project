...
<nav class="navbar navbar-inverse">
   ...
   <form action="laskusivu.php" method="post" id="form1" style="margin-left:10px;width:700px;">

      <h2 style="margin-left:2px;">Lähetä tuntityölasku</h2>
      ...
      <table class="table table-hover">
         ...
         $y_tiedot = "host=dbstud2.sis.uta.fi port=5432 dbname=rp422600 user=rp422600 password=bigchungus";
            ...
            $tyot = pg_query("SELECT kohteet.nimi, tyosuoritukset.tyomuoto, tyosuoritukset.tyo_id FROM kohteet, tyosuoritukset, tehtiin
                        WHERE tyosuoritukset.tyo_id = tehtiin.tyo_id AND tehtiin.kohde_id = kohteet.kohde_id AND tyosuoritukset.tyomuoto ='Tuntityö';");
         ...
         <tr>
            <td>Eräpäivä:</td>
            <td><input type="date" class="form-control" name="erapv" value="2019-05-06"/></td>
         </tr>
         <tr>
            <td>Laskun tila:</td>
            <td><input type="radio" name="laskuntila" value="kesken">Kesken <input type="radio" name="laskuntila" value="valmis" style="margin-left:2px">Valmis</td>
        </tr>
